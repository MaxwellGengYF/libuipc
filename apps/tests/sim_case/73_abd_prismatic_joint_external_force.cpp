...
TEST_CASE("73_abd_prismatic_joint_external_force", "[abd][joint][external_force]")
{
    ...
    // Create prismatic joint along Y axis (single edge connecting two points)
    ...
    // Apply prismatic joint (single-instance API)
    ...
    // Animator: dynamically update external force
