...
class IPCVertexHalfPlaneFrictionalContact final : public VertexHalfPlaneFrictionalContact
{
  public:
    ...
    {
        // Get counts
        SizeT ph_count = info.friction_PHs().size();
        ...
        auto PHs_view             = info.friction_PHs();
                                        ...
                                        IndexT half_plane_vertex_offset)
        {
            ...
            $if(I < ph_count)
            {
                ...
                Vector3 prev_v = prev_positions.read(vI);
