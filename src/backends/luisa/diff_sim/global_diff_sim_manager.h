  ...
  public:
    ...
    class Impl
    {
      public:
        ...
        //\end{bmatrix}
        //$$
        DeviceTripletMatrix<Float, 1> local_triplet_pGpP;
        //tex:
        //$$
        //T = \begin{bmatrix}
        // T^{[1]}   \\
        ...
        //\end{bmatrix}
        //$$
        DeviceTripletMatrix<Float, 1> total_triplet_pGpP;
        DeviceBCOOMatrix<Float, 1>    total_coo_pGpP;
        ...
        //\end{bmatrix}
        //$$
        DeviceTripletMatrix<Float, 1> local_triplet_H;
        //tex:
        //$$
        //T = \begin{bmatrix}
        // H^{[1]}   \\
        ...
        //\end{bmatrix}
        //$$
        DeviceTripletMatrix<Float, 1> total_triplet_H;
        DeviceBCOOMatrix<Float, 1>    total_coo_H;
    ...
    class DiffParmInfo : public BaseInfo
    {
      public:
        ...
        /**
         * @brief Get a view to the pGpP triplet matrix for writing
         * 
         * Returns a view to the local triplet matrix for partial gradient 
         * w.r.t. parameters (pGpP). Reporters should write their contributions
         * to this matrix.
         */
        DeviceTripletMatrix<Float, 1> pGpP() const;
    };
    ...
    class DiffDofInfo : public BaseInfo
    {
      public:
        ...
        /**
         * @brief Get a view to the H triplet matrix for writing
         * 
         * Returns a view to the local triplet matrix for Hessian (H).
         * Reporters should write their contributions to this matrix.
         */
        DeviceTripletMatrix<Float, 1> H() const;
    };
    ...
    class DiffParmUpdateInfo
    {
      public:
        ...
        /**
         * @brief Get a view to the current parameter values
         * 
         * Returns a buffer view to the parameter array on device.
         */
        BufferView<Float> parameters() const noexcept;
