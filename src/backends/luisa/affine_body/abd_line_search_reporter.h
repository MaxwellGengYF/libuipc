  ...
  public:
    ...
    class Impl
    {
      public:
        ...
        luisa::compute::Buffer<Float> body_id_to_kinetic_energy;
        Float                         abd_kinetic_energy;
        luisa::compute::Buffer<Float> body_id_to_shape_energy;
        Float                         abd_shape_energy;

        SimSystemSlotCollection<ABDLineSearchSubreporter> reporters;
        OffsetCountCollection<IndexT> reporter_energy_offsets_counts;
        luisa::compute::Buffer<Float> reporter_energies;
