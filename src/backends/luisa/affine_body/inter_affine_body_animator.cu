...
void InterAffineBodyAnimator::compute_gradient_hessian(ABDLinearSubsystem::AssembleInfo& info)
{
    for(auto constraint : m_impl.constraints.view())
    {
        // Get gradient/hessian views from AssembleInfo
...
span<const AffineBodyDynamics::GeoInfo> InterAffineBodyAnimator::FilteredInfo::geo_infos() const noexcept
{
    return span<const AffineBodyDynamics::GeoInfo>{m_impl->affine_body_dynamics->m_impl.geo_infos};
}
...
Float InterAffineBodyAnimator::BaseInfo::dt() const noexcept
{
    return m_dt;
}

luisa::compute::BufferView<Vector12> InterAffineBodyAnimator::BaseInfo::qs() const noexcept
{
    return m_impl->affine_body_dynamics->qs();
}

luisa::compute::BufferView<Vector12> InterAffineBodyAnimator::BaseInfo::q_prevs() const noexcept
{
    return m_impl->affine_body_dynamics->q_prevs();
}

luisa::compute::BufferView<ABDJacobiDyadicMass> InterAffineBodyAnimator::BaseInfo::body_masses() const noexcept
{
    return m_impl->affine_body_dynamics->body_masses();
}

luisa::compute::BufferView<IndexT> InterAffineBodyAnimator::BaseInfo::is_fixed() const noexcept
{
    return m_impl->affine_body_dynamics->body_is_fixed();
}

luisa::compute::BufferView<Float> InterAffineBodyAnimator::ComputeEnergyInfo::energies() const noexcept
{
    return m_energies;
}

luisa::compute::BufferView<Vector12> InterAffineBodyAnimator::GradientHessianInfo::gradients() const noexcept
{
    return m_gradients;
}

luisa::compute::BufferView<IndexT> InterAffineBodyAnimator::GradientHessianInfo::gradient_indices() const noexcept
{
    return m_gradient_indices;
}

luisa::compute::BufferView<Matrix12x12> InterAffineBodyAnimator::GradientHessianInfo::hessians() const noexcept
{
    return m_hessians;
}

luisa::compute::BufferView<IndexT> InterAffineBodyAnimator::GradientHessianInfo::hessian_row_indices() const noexcept
{
    return m_hessian_row_indices;
}

luisa::compute::BufferView<IndexT> InterAffineBodyAnimator::GradientHessianInfo::hessian_col_indices() const noexcept
{
    return m_hessian_col_indices;
}
