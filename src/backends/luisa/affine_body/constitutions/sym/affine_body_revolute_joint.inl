...
inline LUISA_GENERIC void Hess(luisa::Matrix<Float, 12>& R, const Float& kappa, const luisa::Vector<Float, 3>& x0_bar, const luisa::Vector<Float, 3>& x1_bar, const luisa::Vector<Float, 3>& x2_bar, const luisa::Vector<Float, 3>& x3_bar)
{
/*****************************************************************************************************************************
...
/* Sub Exprs */
Float x0 = 2*kappa;
Float x1 = kappa*(x1_bar[0] + x3_bar[0]);
Float x2 = kappa*(x1_bar[1] + x3_bar[1]);
Float x3 = kappa*(x1_bar[2] + x3_bar[2]);
Float x4 = kappa*(x0_bar[0] + x2_bar[0]);
Float x5 = kappa*(x0_bar[0]*x1_bar[0] + x2_bar[0]*x3_bar[0]);
Float x6 = kappa*(x0_bar[0]*x1_bar[1] + x2_bar[0]*x3_bar[1]);
Float x7 = kappa*(x0_bar[0]*x1_bar[2] + x2_bar[0]*x3_bar[2]);
Float x8 = kappa*(x0_bar[1] + x2_bar[1]);
Float x9 = kappa*(x0_bar[1]*x1_bar[0] + x2_bar[1]*x3_bar[0]);
Float x10 = kappa*(x0_bar[1]*x1_bar[1] + x2_bar[1]*x3_bar[1]);
Float x11 = kappa*(x0_bar[1]*x1_bar[2] + x2_bar[1]*x3_bar[2]);
Float x12 = kappa*(x0_bar[2] + x2_bar[2]);
Float x13 = kappa*(x0_bar[2]*x1_bar[0] + x2_bar[2]*x3_bar[0]);
Float x14 = kappa*(x0_bar[2]*x1_bar[1] + x2_bar[2]*x3_bar[1]);
Float x15 = kappa*(x0_bar[2]*x1_bar[2] + x2_bar[2]*x3_bar[2]);
/* Simplified Expr */
R[0][0] = x0;
R[0][1] = 0;
R[0][2] = 0;
