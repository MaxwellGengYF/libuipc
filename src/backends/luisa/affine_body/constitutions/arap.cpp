  ...
  public:
    ...
    virtual void do_compute_energy(ComputeEnergyInfo& info) override
    {
        ...
        Kernel1D compute_energy_kernel = [&](BufferVar<Vector12> qs,
            ...
            $if(i < body_count) {
                ...
                // Convert Vector12 to Array<float, 12> for arap_function
                abd_arap::Array<float, 12> q_array;
                for(int k = 0; k < 12; ++k) {
                    q_array[k] = q[k];
                }

                Float E;
                abd_arap::E(E, kappa, q_array);
    ...
    virtual void do_compute_gradient_hessian(ComputeGradientHessianInfo& info) override
    {
        ...
        Kernel1D compute_gradient_hessian_kernel = [&](BufferVar<Vector12> qs,
                                                       ...
                                                       BufferVar<Matrix12x12> shape_hessians,
                                                       Bool gradient_only) {
            auto i = dispatch_id().x;
            $if(i < N) {
                ...
                abd_arap::Array<float, 9> G9;
                abd_arap::dEdq(G9, kappa, q_array);
                ...
                $if(!gradient_only) {
                    ...
                    abd_arap::Matrix9x9 H9x9;
                    abd_arap::ddEddq(H9x9, kappa, q_array);
