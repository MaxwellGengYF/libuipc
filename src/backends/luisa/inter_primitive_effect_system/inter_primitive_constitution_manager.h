    ...
    class GradientHessianInfo : public BaseInfo
    {
      public:
        GradientHessianInfo(Impl*                    impl,
                            ...
                            MutableTripletMatrixView<Float, 3> hessians)
            : BaseInfo(impl, index, dt)
        ...
        MutableDoubletVectorView<Float, 3> gradients() const noexcept;
        MutableTripletMatrixView<Float, 3> hessians() const noexcept;
        bool                               gradient_only() const noexcept;

      private:
        friend class InterPrimitiveConstitutionManager;
        MutableDoubletVectorView<Float, 3> m_gradients;
        MutableTripletMatrixView<Float, 3> m_hessians;
