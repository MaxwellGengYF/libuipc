...
LC_GPU_CALLABLE void point_triangle_distance2(const Vector3& p,
                                              ...
                                              Float& dist2)
{
    const Vector3 b   = luisa::cross(t1 - t0, t2 - t0);
    Float         aTb = luisa::dot(p - t0, b);
    dist2             = aTb * aTb / luisa::dot(b, b);
}
...
{
    details::g_PT(
        p.x, p.y, p.z, t0.x, t0.y, t0.z, t1.x, t1.y, t1.z, t2.x, t2.y, t2.z, grad.data());
}
