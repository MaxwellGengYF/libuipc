 ...
 */
inline LUISA_GENERIC Float edge_thickness(const Float& thickness_E0, const Float& thickness_E1)
{
    if constexpr(RUNTIME_CHECK)
    {
        LUISA_ASSERT(thickness_E0 == thickness_E1, "Edge thickness should be the same");
    }
 ...
 */
inline LUISA_GENERIC Float triangle_thickness(const Float& thickness_T0,
                                              const Float& thickness_T1,
                                              const Float& thickness_T2)
{
    if constexpr(RUNTIME_CHECK)
    {
        LUISA_ASSERT(thickness_T0 == thickness_T1 && thickness_T1 == thickness_T2,
 ...
 */
inline LUISA_GENERIC Float PT_thickness(const Float& thickness_P,
 ...
 */
inline LUISA_GENERIC Float EE_thickness(const Float& thickness_Ea0,
                                        ...
                                        const Float& thickness_Eb1)
{
    if constexpr(RUNTIME_CHECK)
    {
        LUISA_ASSERT(thickness_Ea0 == thickness_Ea1 && thickness_Eb0 == thickness_Eb1,
 ...
 */
inline LUISA_GENERIC Float PE_thickness(const Float& thickness_P,
 ...
 */
inline LUISA_GENERIC Float PP_thickness(const Float& thickness_P0, const Float& thickness_P1)
{
 ...
 */
inline LUISA_GENERIC Vector2 D_range(Float xi, Float d_hat)
{
    auto upper = xi + d_hat;
    auto lower = xi;
 ...
 */
inline LUISA_GENERIC bool is_active_D(Vector2 D_range, Float D)
{
