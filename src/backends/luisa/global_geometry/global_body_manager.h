  ...
  public:
    ...
    class BodyAttributeInfo
    {
      public:
        ...
        luisa::compute::BufferView<IndexT> self_collision() const noexcept;
     ...
     */
    luisa::compute::BufferView<const IndexT> self_collision() const noexcept;
  ...
  public:
    class Impl
    {
      public:
        ...
        luisa::compute::Buffer<IndexT> self_collision;
