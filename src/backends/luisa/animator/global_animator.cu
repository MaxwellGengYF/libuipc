...
{
template <>
class backend::SimSystemCreator<luisa::GlobalAnimator>
{
  public:
    static U<luisa::GlobalAnimator> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<luisa::GlobalAnimator>(engine);
    }
};
}  // namespace uipc::backend
