...
template <typename T>
inline void E(T& R, const T& k, const luisa::Vector<T,9>& X, const T& L0, const T& r, const T& pi)
{
/*****************************************************************************************************************************
...
Refactored for LuisaCompute DSL
******************************************************************************************************************************
Symbol Name Mapping:
k:
    -> {}
...
auto x5 = -X(2) + X(5);
auto x6 = -X(5) + X(8);
auto x7 = luisa::pow(x0*x4 + x1*x4 + x5*x6 + luisa::pow((luisa::pow(x0, 2) + luisa::pow(x4, 2) + luisa::pow(x6, 2))*(luisa::pow(x1, 2) + luisa::pow(x4, 2) + luisa::pow(x5, 2)), T(1.0)/T(2.0)), -2);
/* Simplified Expr */
R = (T(1.0)/T(4.0))*k*pi*luisa::pow(r, 4)*(x7*luisa::pow(x0*x2 - 2*x4*x4, 2) + x7*luisa::pow(-2*x0*x5 + 2*x4*x6, 2) + x7*luisa::pow(-x2*x6 + 2*x4*x5, 2))/L0;
}

template <typename T>
inline void dEdX(luisa::Vector<T,9>& R, const T& k, const luisa::Vector<T,9>& X, const T& L0, const T& r, const T& pi)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
auto x7 = -X(2) + X(5);
auto x8 = -X(5) + X(8);
auto x9 = luisa::pow(x3, 2) + luisa::pow(x5, 2) + luisa::pow(x7, 2);
auto x10 = luisa::pow(x4, 2) + luisa::pow(x6, 2) + luisa::pow(x8, 2);
auto x11 = luisa::pow(x10*x9, T(1.0)/T(2.0));
auto x12 = x11 + x3*x4 + x5*x6 + x7*x8;
auto x13 = luisa::pow(x12, -2);
auto x14 = 2*x3;
...
auto x21 = x13*x20;
auto x22 = luisa::pow(x15, 2);
auto x23 = luisa::pow(x12, -3);
auto x24 = 2*X(0);
auto x25 = 2*X(3);
auto x26 = x24 - x25;
auto x27 = x11/x9;
...
auto x31 = luisa::pow(x20, 2);
auto x32 = 2*x5*x8 - 2*x6*x7;
auto x33 = luisa::pow(x32, 2);
auto x34 = (T(1.0)/T(4.0))*k*pi*luisa::pow(r, 4)/L0;
auto x35 = 4*X(3);
auto x36 = -4*X(6);
auto x37 = x35 + x36;
auto x38 = x13*x32;
...
auto x54 = x18 + x53;
auto x55 = -x35;
auto x56 = (T(1.0)/T(2.0))*x10;
auto x57 = (T(1.0)/T(2.0))*x9;
auto x58 = luisa::pow(x10, -1);
auto x59 = 2*x27*x58;
...
template <typename T>
inline void ddEddX(luisa::Matrix<T,9,9>& R, const T& k, const luisa::Vector<T,9>& X, const T& L0, const T& r, const T& pi)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
auto x9 = -X(5) + X(8);
auto x10 = luisa::pow(x4, 2) + luisa::pow(x6, 2) + luisa::pow(x8, 2);
auto x11 = luisa::pow(x5, 2) + luisa::pow(x7, 2) + luisa::pow(x9, 2);
auto x12 = luisa::pow(x10*x11, T(1.0)/T(2.0));
auto x13 = x12 + x4*x5 + x6*x7 + x8*x9;
auto x14 = luisa::pow(x13, -2);
auto x15 = 4*X(4);
auto x16 = -4*X(7);
auto x17 = x15 + x16;
auto x18 = x14*x17;
...
auto x44 = x38*x43;
auto x45 = x27*x44;
auto x46 = luisa::pow(x40, 2);
auto x47 = 3*X(3);
auto x48 = 3*X(6);
auto x49 = -T(3.0)/T(2.0)*x33 - x47 + x48;
auto x50 = luisa::pow(x13, -4);
auto x51 = x37*x50;
auto x52 = x49*x51;
auto x53 = luisa::pow(x43, 2);
auto x54 = 2*x6*x9 - 2*x7*x8;
auto x55 = luisa::pow(x54, 2);
auto x56 = 2*x32;
auto x57 = x12/luisa::pow(x10, 2);
auto x58 = luisa::pow(x31, 2)*x57;
auto x59 = -x31;
auto x60 = x31*x57;
auto x61 = x38*(-x56 - T(1.0)/T(2.0)*x58 - x59*x60);
auto x62 = (T(1.0)/T(4.0))*k*pi*luisa::pow(r, 4)/L0;
auto x63 = 2*X(1);
auto x64 = -x0 + x63;
auto x65 = -x64;
auto x66 = x60*x64;
auto x67 = (T(1.0)/T(2.0))*x66;
auto x68 = x38*(-x60*x65 - x67);
auto x69 = -x36;
auto x70 = 3*X(4);
auto x71 = 3*X(7);
auto x72 = x32*x64;
auto x73 = -x70 + x71 - T(3.0)/T(2.0)*x72;
auto x74 = x51*x73;
auto x75 = 4*X(3);
auto x76 = -4*X(6);
auto x77 = x75 + x76;
...
auto x85 = -x19 + x84;
auto x86 = -x85;
auto x87 = (T(1.0)/T(2.0))*x85;
auto x88 = x60*x87;
auto x89 = x38*(-x60*x86 - x88);
auto x90 = 3*X(5);
auto x91 = 3*X(8);
auto x92 = x32*x85;
auto x93 = -x90 + x91 - T(3.0)/T(2.0)*x92;
auto x94 = x51*x93;
auto x95 = -x17;
auto x96 = -x22 - x92;
auto x97 = x37*x44;
auto x98 = x45*x96 + x77*x97 + x80*x96 + x82*x95;
auto x99 = luisa::pow(x11, -1);
auto x100 = (T(1.0)/T(2.0))*x11;
auto x101 = (T(1.0)/T(2.0))*x10;
...
auto x153 = x12*x99;
auto x154 = x153*x69;
auto x155 = x110 - T(3.0)/T(2.0)*x154 - x47;
auto x156 = x155*x50;
auto x157 = (T(1.0)/T(2.0))*x99;
auto x158 = x157*x33;
...
auto x165 = -x3;
auto x166 = x153*x165;
auto x167 = x127 - T(3.0)/T(2.0)*x166 - x70;
auto x168 = x167*x50;
auto x169 = -x131;
auto x170 = x117 + x135;
auto x171 = -x170;
...
auto x177 = x153*x23;
auto x178 = x144 - T(3.0)/T(2.0)*x177 - x90;
auto x179 = x178*x50;
auto x180 = -x162;
auto x181 = -x177 - x19 + x84;
auto x182 = (T(1.0)/T(2.0))*x23;
auto x183 = x182*x99;
auto x184 = x183*x33;
auto x185 = x184*x38;
...
auto x194 = x79*x81;
auto x195 = x190*x73;
auto x196 = x57*luisa::pow(x64, 2);
auto x197 = x38*(-x187*x65 - T(1.0)/T(2.0)*x196 - x56);
auto x198 = x187*x87;
...
auto x243 = x81*x95;
auto x244 = x236*x93;
auto x245 = x57*luisa::pow(x85, 2);
auto x246 = x38*(-x233*x86 - T(1.0)/T(2.0)*x245 - x56);
auto x247 = x103*x233;
...
auto x275 = 2*x57;
auto x276 = x103*x275;
auto x277 = x38*(-x104 - x274*(-x11 + (T(1.0)/T(2.0))*x31*x36) - x276*x59 - 2);
auto x278 = x116*x14;
auto x279 = x120*x14;
auto x280 = x118*x50;
auto x281 = x280*x49;
...
auto x290 = x112*x280;
auto x291 = x10 + x11;
auto x292 = luisa::pow(x11, -2);
auto x293 = x275*x292;
auto x294 = x102*x292;
auto x295 = x294*x56;
auto x296 = x38*(-luisa::pow(x102, 2)*x293 - 2*x104 - x274*(x291 + x36*x59) - x295*x69 + 4);
auto x297 = (T(1.0)/T(2.0))*x59;
auto x298 = (T(1.0)/T(2.0))*x36;
auto x299 = x102*x293;
...
auto x313 = x38*(-x274*(-x10 + (T(1.0)/T(2.0))*x59*x69) - x295*x36 - x312);
auto x314 = x155*x280;
...
auto x327 = x3*x99;
auto x328 = x123*x275;
auto x329 = x38*(-x124 - x328*x33 - x328*x59);
auto x330 = x136*x14;
auto x331 = x134*x50;
auto x332 = x331*x49;
auto x333 = x38*(-x209 - x274*(-x11 + (T(1.0)/T(2.0))*x3*x64) - x328*x65 - 2);
auto x334 = x132*x14;
auto x335 = x331*x73;
auto x336 = x38*(-x253 - x328*x92 - x328*x86);
auto x337 = x331*x93;
auto x338 = x122*x292;
auto x339 = x338*x56;
...
auto x344 = x132*x81;
auto x345 = x128*x331;
auto x346 = x38*(-luisa::pow(x122, 2)*x293 - x165*x339 - 2*x209 - x274*(x291 + x3*x65) + 4);
auto x347 = x122*x139*x293 + x274*((T(1.0)/T(2.0))*x22*x65 + (T(1.0)/T(2.0))*x3*x86);
...
auto x360 = x38*(-x274*(-x10 + (T(1.0)/T(2.0))*x165*x65) - x3*x339 - x359);
auto x361 = x167*x331;
...
auto x374 = x115*x14;
auto x375 = x371*x73;
auto x376 = x38*(-x258 - x274*(-x11 + (T(1.0)/T(2.0))*x22*x85) - x368*x86 - 2);
auto x377 = x371*x93;
auto x378 = x139*x292;
auto x379 = x378*x56;
...
auto x386 = x115*x81;
auto x387 = x145*x371;
auto x388 = x38*(-luisa::pow(x139, 2)*x293 - x23*x379 - 2*x258 - x274*(x22*x86 + x291) + 4);
auto x389 = x86*x99;
auto x390 = x311*x378;
...
auto x402 = x38*(-x22*x379 - x274*(-x10 + (T(1.0)/T(2.0))*x23*x86) - x401);
auto x403 = x178*x371;
...
auto x412 = -x411;
auto x413 = x12*x292;
auto x414 = x413*luisa::pow(x69, 2);
...
auto x426 = x161*x44;
auto x427 = x155*x407;
auto x428 = x38*(-x36*x417 - x411 - T(1.0)/T(2.0)*x414);
auto x429 = (T(1.0)/T(2.0))*x418;
...
auto x447 = x112*x441;
auto x448 = luisa::pow(x165, 2)*x413;
...
auto x457 = x172*x81;
auto x458 = x167*x441;
auto x459 = x38*(-x3*x451 - x411 - T(1.0)/T(2.0)*x448);
auto x460 = x182*x451;
...
auto x474 = x128*x466;
auto x475 = luisa::pow(x23, 2)*x413;
...
auto x482 = x167*x466;
auto x483 = x178*x466;
auto x484 = x38*(-x22*x478 - x411 - T(1.0)/T(2.0)*x475);
/* Simplified Expr */
