...
template <typename T>
inline void E(T& R, const T& k, const std::array<T, 9>& X, const T& L0, const T& r, const T& pi)
{
/*****************************************************************************************************************************
...
auto x5 = -X[2] + X[5];
auto x6 = -X[5] + X[8];
auto x7 = pow(x0*x4 + x1*x4 + x5*x6 + pow((pow(x0, 2) + pow(x4, 2) + pow(x6, 2))*(pow(x1, 2) + pow(x4, 2) + pow(x5, 2)), T(1.0)/T(2.0)), -2);
/* Simplified Expr */
R = (T(1.0)/T(4.0))*k*pi*pow(r, 4)*(x7*pow(x0*x2 - 2*x4*x4, 2) + x7*pow(-2*x0*x5 + 2*x4*x6, 2) + x7*pow(-x2*x6 + 2*x4*x5, 2))/L0;
}

template <typename T>
inline void dEdX(std::array<T, 9>& R, const T& k, const std::array<T, 9>& X, const T& L0, const T& r, const T& pi)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
auto x7 = -X[2] + X[5];
auto x8 = -X[5] + X[8];
auto x9 = pow(x3, 2) + pow(x5, 2) + pow(x7, 2);
auto x10 = pow(x4, 2) + pow(x6, 2) + pow(x8, 2);
auto x11 = pow(x10*x9, T(1.0)/T(2.0));
...
auto x33 = pow(x32, 2);
auto x34 = (T(1.0)/T(4.0))*k*pi*pow(r, 4)/L0;
auto x35 = 4*X[3];
auto x36 = -4*X[6];
auto x37 = x35 + x36;
auto x38 = x13*x32;
...
template <typename T>
inline void ddEddX(std::array<std::array<T, 9>, 9>& R, const T& k, const std::array<T, 9>& X, const T& L0, const T& r, const T& pi)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
auto x9 = -X[5] + X[8];
auto x10 = pow(x4, 2) + pow(x6, 2) + pow(x8, 2);
auto x11 = pow(x5, 2) + pow(x7, 2) + pow(x9, 2);
auto x12 = pow(x10*x11, T(1.0)/T(2.0));
...
auto x55 = pow(x54, 2);
auto x56 = 2*x32;
auto x57 = x12/pow(x10, 2);
auto x58 = pow(x31, 2)*x57;
auto x59 = -x31;
auto x60 = x31*x57;
auto x61 = x38*(-x56 - T(1.0)/T(2.0)*x58 - x59*x60);
auto x62 = (T(1.0)/T(4.0))*k*pi*pow(r, 4)/L0;
auto x63 = 2*X[1];
auto x64 = -x0 + x63;
auto x65 = -x64;
auto x66 = x60*x64;
...
auto x294 = x102*x292;
auto x295 = x294*x56;
auto x296 = x38*(-pow(x102, 2)*x293 - 2*x104 - x274*(x291 + x36*x59) - x295*x69 + 4);
...
auto x344 = x132*x81;
auto x345 = x128*x331;
auto x346 = x38*(-pow(x122, 2)*x293 - x165*x339 - 2*x209 - x274*(x291 + x3*x65) + 4);
...
auto x386 = x115*x81;
auto x387 = x145*x371;
auto x388 = x38*(-pow(x139, 2)*x293 - x23*x379 - 2*x258 - x274*(x22*x86 + x291) + 4);
auto x389 = x86*x99;
auto x390 = x311*x378;
