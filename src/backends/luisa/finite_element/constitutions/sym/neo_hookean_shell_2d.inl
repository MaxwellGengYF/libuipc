...
template <typename T>
inline void A(luisa::Matrix<T, 2>& R, const std::array<T, 9>& X)
{
/*****************************************************************************************************************************
...
/* Simplified Expr */
R[0][0] = pow(x0, 2) + pow(x1, 2) + pow(x2, 2);
R[0][1] = x6;
R[1][0] = x6;
R[1][1] = pow(x3, 2) + pow(x4, 2) + pow(x5, 2);
}

template <typename T>
inline void E(T& R, const T& lambda, const T& mu, const std::array<T, 9>& X, const luisa::Matrix<T, 2>& IB)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
/* Simplified Expr */
R = (T(1.0)/T(8.0))*lambda*pow(x29, 2) + (T(1.0)/T(2.0))*mu*(IB[0][0]*(pow(x30, 2) + pow(x31, 2) + pow(x32, 2)) + IB[0][1]*x36 + IB[1][0]*x36 + IB[1][1]*(pow(x33, 2) + pow(x34, 2) + pow(x35, 2)) - x29 - 2);
}

template <typename T>
inline void dEdX(std::array<T, 9>& R, const T& lambda, const T& mu, const std::array<T, 9>& X, const luisa::Matrix<T, 2>& IB)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
auto x76 = (T(1.0)/T(4.0))*lambda*log(x72*(IB[0][0]*IB[1][1] - IB[0][1]*IB[1][0]));
auto x77 = -x42 + x46;
auto x78 = 2*X[7];
auto x79 = x46 - x78;
...
template <typename T>
inline void ddEddX(std::array<std::array<T, 9>, 9>& R, const T& lambda, const T& mu, const std::array<T, 9>& X, const luisa::Matrix<T, 2>& IB)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
auto x463 = x232*x453;
/* Simplified Expr */
R[0][0] = pow(x42, 2)*x80 + x86*x87 + x87*x90 + x94*(-x86 - x90 + x93);
...
R[1][1] = pow(x113, 2)*x80 + x240*x87 + x241*x87 + x94*(-x240 - x241 + x93);
...
R[2][2] = pow(x133, 2)*x80 + x307*x87 + x308*x87 + x94*(-x307 - x308 + x93);
...
R[3][3] = pow(x144, 2)*x80 + x353*x87 + x354*x87 + x94*(-x353 - x354 - x355);
...
R[4][4] = pow(x180, 2)*x80 + x383*x87 + x384*x87 + x94*(-x355 - x383 - x384);
...
R[5][5] = pow(x202, 2)*x80 + x407*x87 + x408*x87 + x94*(-x355 - x407 - x408);
...
R[6][6] = pow(x206, 2)*x80 + x429*x87 + x430*x87 + x94*(-x429 - x430 - x431);
...
R[7][7] = pow(x222, 2)*x80 + x448*x87 + x449*x87 + x94*(-x431 - x448 - x449);
...
R[8][8] = pow(x231, 2)*x80 + x462*x87 + x463*x87 + x94*(-x431 - x462 - x463);
}
