...
{
class FEM3DConstitutionDiffParmReporter : public FiniteElementConstitutionDiffParmReporter
{
  public:
    ...
    {
      public:
        DiffParmInfo(FEM3DConstitutionDiffParmReporter* impl, Base::DiffParmInfo& diff_parm_info)
            : m_impl(impl)
        ...
        luisa::compute::BufferView<const float>         rest_volumes() const noexcept;
        luisa::compute::BufferView<const luisa::float3x3> Dm_invs() const noexcept;
        luisa::compute::BufferView<const luisa::int4>   indices() const noexcept;
      ...
      protected:
        FEM3DConstitutionDiffParmReporter* m_impl = nullptr;
