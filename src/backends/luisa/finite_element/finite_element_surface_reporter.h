  ...
  public:
    ...
    class Impl
    {
      public:
        ...
        // core invariant data
        luisa::vector<SurfaceInfo> body_surface_infos;

        luisa::vector<SizeT> geo_surf_vertex_offsets;
        luisa::vector<SizeT> geo_surf_vertex_counts;
        luisa::vector<SizeT> geo_surf_edge_offsets;
        luisa::vector<SizeT> geo_surf_edge_counts;
        luisa::vector<SizeT> geo_surf_triangle_offsets;
        luisa::vector<SizeT> geo_surf_triangle_counts;

        luisa::vector<IndexT>   surf_vertices;
        luisa::vector<luisa::int2> surf_edges;
        luisa::vector<luisa::int3> surf_triangles;
    };
