  ...
  public:
    ...
    class BaseInfo
    {
      public:
        ...
        luisa::compute::BufferView<const Matrix3x3> Dm_invs() const;
        luisa::compute::BufferView<const Float>     rest_volumes() const;
        luisa::compute::BufferView<const Vector4i>  indices() const;
