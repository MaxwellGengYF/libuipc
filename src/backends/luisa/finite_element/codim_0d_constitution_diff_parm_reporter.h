...
{
class Codim0DConstitutionDiffParmReporter : public FiniteElementConstitutionDiffParmReporter
{
  public:
    ...
    {
      public:
        DiffParmInfo(Codim0DConstitutionDiffParmReporter* impl, Base::DiffParmInfo& diff_parm_info)
            : m_impl(impl)
        ...
        luisa::compute::BufferView<const int>           indices() const noexcept;
      ...
      protected:
        Codim0DConstitutionDiffParmReporter* m_impl = nullptr;
