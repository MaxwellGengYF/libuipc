...
luisa::compute::BufferView<const Vector3> FiniteElementExtraConstitution::BaseInfo::xs() const noexcept
{
    return m_impl->finite_element_method->xs();
}

luisa::compute::BufferView<const Vector3> FiniteElementExtraConstitution::BaseInfo::x_bars() const noexcept
{
    return m_impl->finite_element_method->x_bars();
}

luisa::compute::BufferView<const Float> FiniteElementExtraConstitution::BaseInfo::thicknesses() const noexcept
{
